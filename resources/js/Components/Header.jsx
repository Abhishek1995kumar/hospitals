...
export default function Header({Breadcrumb}) {
    ...
    const { authDetails } = usePage().props;

    return (
        <div id="kt_header" className="header align-items-stretch">
            <div className="header-brand">
                <Link href="#" className="d-flex align-items-center gap-5" id="kt_header_logo">
                    <img alt="Logo" src="assets/media/logos/logos.png" style="height: 50px;" />
                    <span style="fontSize: 30px; color: white; font-weight: 500; "></span>
                </Link>
            ...
            <div className="toolbar d-flex align-items-stretch">
                <div className="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                    ...
                    <div className="d-flex align-items-center gap-3">
                        <Link href="/admin/notification" className="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary" style="position: relative;">
                            <i className="far fa-bell text-primary" style="fontSize: 25px;"></i>
                            <span style="position: absolute; top: 0; right: -5px; padding: 0 5px 0 5px; border-radius: 50%; background-color: #0093dd; color: #fff;">
                                9+
                            </span>
                        </Link>

                        <Link href="#" className="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div className="aside-user-info flex-row-fluid flex-wrap mt-1">
                            <div className="d-flex">
                                <div className="me-n2">
                                    <Link href="#" className="btn btn-icon btn-sm btn-active-color-primary mt-n2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-overflow="true">
                                    ...
                                    <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                        <div className="menu-item px-3">
                                            <div className="menu-content d-flex align-items-center px-3">
                                                <div className="symbol symbol-50px me-5">
                                                    <img alt="Logo" src="" onerror="this.onerror=null;this.src='/Linkssets/media/blank.png'" />
                                                </div>
                                                <div className="d-flex flex-column">
                                                    <div className="fw-bold d-flex align-items-center fs-5"> {authDetails?.name} </div>
                                                    <Link href="#" className="fw-semibold text-muted text-hover-primary fs-7">{authDetails?.email}</Link>
                                                    <div className="fw-bold d-flex align-items-center fs-5">
                                                        <span className="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{authDetails?.role}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="menu-item px-5">
                                            <Link href="#" className="menu-link px-5" onClick={handleProfile}>My Profile</Link>
                                        </div>

                                        <div className="separator my-2"></div>

                                        <div className="menu-item px-5">
                                            <Link href="#" className="menu-link px-5" onClick={handleLogout} > Sign Out </Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu">
                            ...
                            <div className="menu-item px-3 my-0">
                                <Link href="#" className="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
                                    <span className="menu-icon" data-kt-element="icon">
                                        <span className="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
