                    ...
                    <div class="hover-scroll-overlay-y my-5 px-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            @permission('hospital.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Hospital Management') }}</span>
                                    </div>
                                </div>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">{{ __('Hospital') }}</span>
                            ...
                            @permission('clinic.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Clinic Management') }}</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Multiple Clinic Setup') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Clinic Timings')}}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Doctor Assignment') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @permission('doctor.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Doctor Management') }}</span>
                                    </div>
                                </div>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">{{ __('Doctor') }}</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Registration') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('E-Prescription') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @permission('patient.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Patient Management') }}</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">{{ __('Patient') }}</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                            ...
                            @permission('opd.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('OPD Management') }}</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">{{ __('OPD System') }}</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('OPD Ticket') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @permission('ipd.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('IPD Management') }}</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">{{ __('IPD System') }}</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Admission') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Bed Management') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Nursing') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Discharge') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @permission('laboratory.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Laboratory Management') }}</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Pathology') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Cardiology') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Sonography') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('MRI') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Mammography') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('X-Ray') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('CT Scan') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                            ...
                            @permission('pharmacy.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Pharmacy Management') }}</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/pharmacy/madicine*') ? 'active' : ''}}" href="{{ url('admin/pharmacy/madicine') }}">
                                                ...
                                                <span class="menu-title">{{ __('Medicine') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                            ...
                            @permission('billing.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Billing Management') }}</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Billing Types') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Invoice Features') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @permission('payroll.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Payroll Management') }}</span>
                                    </div>
                                </div>
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Ticket Raise') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Run Payslip') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @permission('emergency.view')
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Emergency Management') }}</span>
                                    </div>
                                </div>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">{{ __('Emergency') }}</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Ambulance') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link " href="#">
                                                ...
                                                <span class="menu-title">{{ __('Critical Care') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- System Settings -->
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('Settings Management') }}</span>
                                    </div>
                                </div>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item  menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link  {{Request::is('admin/plans*') ? 'active' : ''}}" href="{{ url('admin/plans') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link  {{Request::is('admin/customer*') ? 'active' : ''}}" href="{{ url('admin/customer') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/authentication*') ? 'active' : ''}}" href="{{ url('admin/authentication') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/departments*') ? 'active' : ''}}" href="{{ url('admin/departments') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/subscriptions*') ? 'active' : ''}}" href="{{ url('admin/subscriptions') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">{{ __('Subscription Settings') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    @endpermission
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link {{Request::is('admin/maintenances*') ? 'active' : ''}}" href="{{ url('admin/maintenances') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">{{ __('Cache Clear') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                    @endpermission
                    ...
                    <div class="toolbar d-flex align-items-stretch">
                        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="aside-user-info flex-row-fluid flex-wrap mt-1">
                                    <div class="d-flex">
                                        <div class="me-n2">
