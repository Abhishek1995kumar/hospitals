...
@section('content')
    <div id="">
        <a href="javascript:void(0)" class="btn btn-info mb-4" id="backSupplierList">
            {{ __('Back')}}
        </a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4 " id="credit_daysDiv">
                                    <div class="form-group">
                                        <label class="required fs-6 fw-semibold mb-2">{{ __('Credit Days')}}</label>
                                        <input name="credit_days" id="credit_days" class="form-control" type="text" maxlength="5" placeholder="Enter credit days" >
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4 " id="contact_personDiv">
                                    <div class="form-group">
                                        <label class="required fs-6 fw-semibold mb-2">{{ __('Contact Person')}}</label>
                                        <input name="contact_person" id="contact_person" class="form-control" type="text" maxlength="100" placeholder="Enter contact person" >
                                    </div>
                                </div>
                        ...
                        <div class="card-footer modal-footer">
                            <button type="submit" form="supplierForm" class="btn btn-primary savePharmacySupplierBtn" id="" onclick="savePharmacySupplier(event)">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
