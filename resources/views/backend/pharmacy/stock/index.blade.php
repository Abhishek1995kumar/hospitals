    ...
    <div class="row">
        <div class="col-3">
            <div class="alert alert-success text-center border border-success">
                <h5 class="alert-heading">{{ __('Out Of Stock')}}</h5>
                <p class="mb-0" id="completeValue"></p>
            </div>
        </div>
        <div class="col-3">
            <div class="alert alert-success text-center border border-success">
                <h5 class="alert-heading">{{ __('Total Expired')}}</h5>
                <p class="mb-0" id="completeValue"></p>
            </div>
        </div>
    </div>
        ...
        <div class="card-header border-0 pt-6">
            <ul class="nav nav-tabs" id="roleTabMenu" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="roleTabBtn" data-bs-toggle="tab" data-bs-target="#roleTab" type="button" role="tab"> {{ __('Out Of Stocks') }} </button>
                </li>
                @endpermission

                @permission('module.view')
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="moduleTabBtn" data-bs-toggle="tab" data-bs-target="#moduleTab" type="button" role="tab"> {{ __('Expired Dashboard') }} </button>
                </li>
                @endpermission
            </ul>
        </div>
