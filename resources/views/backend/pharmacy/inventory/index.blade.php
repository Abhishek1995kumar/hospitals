...
@section('title') {{ __('Inventory')}} @endsection
...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">{{ __('Inventory')}}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('Inventory')}}</li>
    </ul>
@endsection
