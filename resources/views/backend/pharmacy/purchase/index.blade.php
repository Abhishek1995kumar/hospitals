...
@section('title') {{ __('Purchase')}} @endsection
...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">{{ __('Purchase')}}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('Purchase')}}</li>
    </ul>
@endsection
        ...
        <div class="card-header border-0 pt-6">
            <ul class="nav nav-tabs" id="roleTabMenu" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="roleTabBtn" data-bs-toggle="tab" data-bs-target="#roleTab" type="button" role="tab"> {{ __('Purchase Dashboard') }} </button>
                </li>
                @endpermission
