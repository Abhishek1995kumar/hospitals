...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Botler Create</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-dark">
        <a href="{{ route('admin.master.botler.list') }}" class="text-muted text-hover-primary">Botler</a>
    </li>
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-200 w-5px h-2px"></span>
    </li>
...
<form id="quickForm" action="{{ route('admin.master.botler.save') }}" method="POST" enctype="multipart/form-data">
    @csrf
