...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Sub Bottler List</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-dark">Sub Bottler Details</li>
</ul>
@endsection
        ...
        <div class="card-header border-0 pt-6" style="justify-content: left !important;">
            <div class="card-title">
                <div class="card-toolbar">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSubBotler" class="btn btn-primary" >
                    <i class="fa fa-plus"></i>Add Sub Bottler </button> 
                    </button>
                </div>
            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-6 " id="memberCountDiv">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4 mb-4 " id="volunteerContactDiv">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="volunteer_contact" id="volunteerContactId" class="form-control"  accept=".png, .jpg, .jpeg, .pdf" >
                                                    <span class="text-muted">Support only png/jpg/jpeg/pdf file and file size less than 2 mb</span>
                                                    <div class="invalid-feedback d-none">Upload Photo Second required</div>
                                                </div>
                                            </div>
    ...
    <div class="modal fade modal-lg" id="editSubBotler" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="addBotlerTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editSubBotlerForm" action="{{ route('admin.user.sub-botler.save') }}" method="POST" enctype="multipart/form-data">
                        <input name="_token" type="hidden" value="{{ csrf_token() }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
