...
@section('content')
        ...
        <div class="card-header border-0 pt-6">
            <ul class="nav nav-tabs" id="roleTabMenu" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="costTabBtn" data-bs-toggle="tab" data-bs-target="#costTab" type="button" role="tab"> {{ __('Cost Amount') }} </button>
                </li>
                <li class="nav-item" role="presentation">
    ...
    <!-- Department start -->
        <!-- Super admin ka department -- Systems Administrator -->
        <!-- Customer admin ka department --  -->
...
<script>
    $(document).ready(function() {
        loadData('role');
        $('#costTabBtn').on('show.bs.tab', function (e) {
            loadData('role');
        });
        $('#parentTabBtn').on('show.bs.tab', function (e) {
            loadData('permission');
        });
        $('#childTabBtn').on('show.bs.tab', function (e) {
